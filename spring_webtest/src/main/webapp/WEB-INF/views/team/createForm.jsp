...
<div class="container">
<h2>등록</h2>
<form name="frm" action="./create" method="post" size="85"
...
<table style="width: 510px; height: 64px; ">
	...
	<tr>
	<th>이름	</th>
	<td><input type ="text" name="name" style="width: 307px; height: 38px; "></td>
	</tr>
	...
	<td><input type="text" name="zipcode" size="7" 
			maxlength="5" id="zipcode" placeholder="우편번호">
	...
	<tr>
	<th >주소</th>
	<td><input type="text" name="address" size="50" id="address" placeholder="주소">
		<input type="text" name="address2" size="50" id="address2" placeholder="상세주소">
	</td>
	</tr>
</table>
<div>
