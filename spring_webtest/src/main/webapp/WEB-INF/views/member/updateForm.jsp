 ...
 <FORM name='frm' method='POST' action='./update'
  ...
  <TABLE>
    <TR>
      ...
      <TD colspan="3"><img src="./storage/${dto.fname}"></TD>
    ...
    <TR>
      ...
      <TD><input type="text" name="email" size="25" value="${dto.email }"
      			onclick="emailCheck2(this)"> <!-- this로 커서올린것을 가져간다 -->
    ...
    <TR>
      ...
      <TD><input type="text" name="address1" size="40"
      			id="sample6_address" value="${dto.address1 }">
      			<input type="text" name="address2" size="40"
      			id="sample6_address2" value="${dto.address2 }"></TD>
      <TD></TD>
    </TR>
    <TR>
      <TH>*직업</TH>
